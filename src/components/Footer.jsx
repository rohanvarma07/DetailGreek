      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center space-x-3 mb-4">
              <div className="w-10 h-10 bg-gradient-to-r from-yellow-400 to-yellow-500 rounded-full flex items-center justify-center">
                <span className="text-black font-bold text-lg">DG</span>
              </div>
              <h3 className="text-xl font-bold text-white">DetailGreek</h3>
            </div>
            <p className="text-gray-400 mb-4 max-w-md">
              Premium car detailing services with professional-grade products and expert techniques. 
              Transform your vehicle with our comprehensive care solutions.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#products" className="text-gray-400 hover:text-yellow-400 transition-colors duration-300">Products</a></li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              ...
              <li className="flex items-center space-x-2">
                ...
                <span>info@detailgreek.com</span>
              </li>
              <li className="flex items-start space-x-2">
                ...
                <span>123 Detail Street<br />Car City, CC 12345</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-white/10 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm">
            © 2025 DetailGreek. All rights reserved.
          </p>
